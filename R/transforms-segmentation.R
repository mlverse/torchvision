...
#'   `height` and `width`. Coordinates use zero-based pixel offsets
#'   (top/left start at 0); `height` and `width` are in pixels.
...
#' )
#'
#' targets[[1]]$boxes # Bounding box clipped and translated to crop coordinates
#'
#' targets[[1]]$labels # Labels corresponding to retained boxes
#' }
#'
#' @references
#' SAHI Documentation:

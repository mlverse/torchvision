...
#' @export
item_transform_rotate <- function(x, angle, interpolation = 2, expand = TRUE,
                                  center = NULL, fill = 0) {
  UseMethod("item_transform_rotate", x)
}

#' @export
item_transform_rotate.default <- function(x, angle, interpolation = 2, expand = TRUE,
                                          center = NULL, fill = 0) {
  cli_abort(
...
#' @export
item_transform_rotate.image_with_bounding_box <- function(x, angle, interpolation = 2, expand = TRUE,
                                                          center = NULL, fill = 0) {

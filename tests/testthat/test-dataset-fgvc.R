...
test_that("tests for the FGVC-Aircraft dataset", {
  ...
  expect_equal(fgcv$classes$manufacturer[item$y$manufacturer],"Boeing")
  expect_equal(fgcv$classes$family[item$y$family],"Boeing 707")
  expect_equal(fgcv$classes$variant[item$y$variant],"707-320")

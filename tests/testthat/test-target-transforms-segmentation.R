...
test_that("target_transform_sahi_crop handles batch of targets", {
  ...
  expect_bbox_is_xyxy(out[[1]][[1]]$boxes, c(50, 50))
  expect_bbox_is_xyxy(out[[2]][[1]]$boxes, c(50, 50))
  expect_bbox_is_xyxy(out[[1]][[2]]$boxes, c(100, 100))
  expect_bbox_is_xyxy(out[[2]][[2]]$boxes, c(100, 100))

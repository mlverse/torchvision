...
test_that("cifar10", {
  ...
  el <- ds[1]
  expect_identical(dim(el[[1]]), c(32, 32, 3))
  expect_length(el[[2]], 1)
  expect_named(el, c("x", "y"))
  expect_identical(ds$classes[el[[2]]], "frog")
...
test_that("cifar100", {
  ...
  expect_length(el[[2]], 1)
  expect_named(el, c("x", "y"))
  expect_identical(ds$classes[el[[2]]], "motorcycle")
  ...
  expect_length(el[[2]], 1)
  expect_named(el, c("x", "y"))
  expect_identical(ds$classes[el[[2]]], "mouse")

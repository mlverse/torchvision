test_that("tests for non-pretrained model_fasterrcnn_resnet50_fpn", {
  ...
  model <- model_fasterrcnn_resnet50_fpn(num_classes = 10, score_thresh = 0.6, nms_thresh = 0.9, detections_per_img = 100)
  out <- model(input)
  expect_named(out, c("features","detections"))
  expect_named(out$detections, c("boxes","labels", "scores"))
  expect_tensor(out$detections$boxes)
...
test_that("tests for non-pretrained model_fasterrcnn_resnet50_fpn_v2", {
  ...
  model <- model_fasterrcnn_resnet50_fpn_v2(score_thresh = 0.6, nms_thresh = 0.9, detections_per_img = 100)
...
test_that("tests for non-pretrained model_fasterrcnn_mobilenet_v3_large_fpn", {
  ...
  model <- model_fasterrcnn_mobilenet_v3_large_fpn(score_thresh = 0.6, nms_thresh = 0.9, detections_per_img = 100)
...
test_that("tests for non-pretrained model_fasterrcnn_mobilenet_v3_large_320_fpn", {
  ...
  model <- model_fasterrcnn_mobilenet_v3_large_320_fpn(score_thresh = 0.6, nms_thresh = 0.9, detections_per_img = 100)
...
test_that("tests for pretrained model_fasterrcnn_mobilenet_v3_large_320_fpn", {
  ...
  model <- model_fasterrcnn_mobilenet_v3_large_320_fpn(pretrained = TRUE, score_thresh = 0.6, nms_thresh = 0.9, detections_per_img = 100)
